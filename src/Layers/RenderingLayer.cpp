...
void RenderingLayer::OnAttach()
{
...

    {
        glm::vec3 vertices[] = {
            ...
            m_VoxelScale * (glm::vec3(m_World.GetSize().x, 0.0f, 0.0f) - glm::vec3(0.5f, 0.5f, 0.5f)),
            m_VoxelScale * (glm::vec3(m_World.GetSize().x, 0.0f, m_World.GetSize().z) - glm::vec3(0.5f, 0.5f, 0.5f)),
            m_VoxelScale * (glm::vec3(0.0f, 0.0f, m_World.GetSize().z) - glm::vec3(0.5f, 0.5f, 0.5f)),

            m_VoxelScale * (glm::vec3(0.0f, m_World.GetSize().y, 0.0f) - glm::vec3(0.5f, 0.5f, 0.5f)),
            m_VoxelScale * (glm::vec3(m_World.GetSize().x, m_World.GetSize().y, 0.0f) - glm::vec3(0.5f, 0.5f, 0.5f)),
            m_VoxelScale * (glm::vec3(m_World.GetSize().x, m_World.GetSize().y, m_World.GetSize().z) - glm::vec3(0.5f, 0.5f, 0.5f)),
            m_VoxelScale * (glm::vec3(0.0f, m_World.GetSize().y, m_World.GetSize().z) - glm::vec3(0.5f, 0.5f, 0.5f))};
